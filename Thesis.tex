...
\include{sections/01Summary}
\include{sections/02Introduction}
\include{sections/03Problem}
\include{sections/04Design}
\include{sections/05Implementation}
\include{sections/06Testing}
\include{sections/07Conclusion}
